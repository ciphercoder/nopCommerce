...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class BookModelFactory : IBookModelFactory
    {
        ...
        //    var shoppingCart = _shoppingCartService.GetShoppingCart(customer, (ShoppingCartType)searchModel.ShoppingCartTypeId)
        //        .ToPagedList(searchModel);
        ...
        public BookModel PrepareBookModel(BookModel model)
        {
            throw new NotImplementedException();
        }

        public BookSearchModel PrepareBookSearchModel(BookSearchModel searchModel)
        {
           var books = _bookService.GetAllBooks().Select(book =>  new BookModel { Id = book.Id, Name = book.Name}).ToList();
            searchModel.BookList = books;
            return searchModel;
        }
    }
}